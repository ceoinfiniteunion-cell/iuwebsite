!function(){if(window.innerWidth<=768){
  ...
  if(_b)_b.style.width="100%";
  if(_n)_n.textContent="100";
  setTimeout(()=>{if(_l)_l.classList.add("done")},600);
  return;
}
}();
...
window.addEventListener("iu:glb-loaded",function(){setTimeout(function(){var l=document.getElementById("loader");if(l)l.parentNode.removeChild(l);},1000)});window.addEventListener("load",function(){setTimeout(function(){var l=document.getElementById("loader");if(l)l.parentNode.removeChild(l);},9000)});
